...
RC LogicalPlanGenerator::create_plan(UpdateStmt *update_stmt, unique_ptr<LogicalOperator> &logical_operator)
{
  ...
  // consider the multi fields update
  ...
  if (filter_stmt != nullptr) {
    ...
    table_get_oper.reset(predicate_oper.get());
  }

  unique_ptr<LogicalOperator> update_oper(new UpdateLogicalOperator(table, update_stmt->values(), fields));
